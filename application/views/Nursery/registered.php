...
<body>
	...
	<!--content-->
		...
		<div class="main-agileits">
				<div class="form-w3agile form1">
					...
					<form action="<?php echo base_url('index.php/Nurserycontroller/register_insert')?>" method="post" enctype="multipart/form-data">
						...
						<div class="key">
							...
							<input  type="email" value="Nursery Email Id" name="email" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Email';}" required="">
							<div class="clearfix" ></div>
						</div>
						<div class="key">
						...
						<div class="key">
							<i class="fa fa-user" aria-hidden="true"></i>
							<input  type="text" value="experience" name="experience" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Username';}" required="">
							<div class="clearfix"></div>
						</div>
						<div class="key">
							<i class="fa fa-user" aria-hidden="true"></i>
						...
						<div class="key">
							<i class="fa fa-user" aria-hidden="true"></i>
							<input  type="text" value="Delivery Boy Password" name="delivery_boy_password" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Delivery Boy Password';}" required="">
							<div class="clearfix"></div>
						</div>


						<div class="key">
							<label>Delivery Boy Driving Licence</label>
							<i class="fa fa-user" aria-hidden="true"></i>
							<input  type="file" value="liecence" name="dboy_licence" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Username';}" required="">
							<div class="clearfix"></div>
						</div>
						<div class="key">
							<label>Delivery Boy Aadhar</label>
							<i class="fa fa-user" aria-hidden="true"></i>
				...
				<div>
				<a href="<?php echo base_url('index.php/nurserycontroller/login'); ?>" class="forg-right" style="color:black;color: white"><b style="font-size: 15px">Login Now</b></a>
